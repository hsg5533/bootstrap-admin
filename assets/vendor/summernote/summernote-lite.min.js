...
!(function (t, e) {
  ...
  var n = (function () {
      ...
      function (t, e) {
        e &&
          ...
          t
            ...
            .on("click", function (t) {
              $(t.currentTarget).data("_lite_tooltip").hide();
            })),
    ...
    k = t('<div class="checkbox"></div>', function (t, e) {
      t.html(
        [
          "<label" + (e.id ? ' for="' + e.id + '"' : "") + ">",
  ...
  var R = /Edge\/\d+/.test(T),
    ...
    P = {
      ...
      isMSIE: N,
      isEdge: R,
      isFF: !R && /firefox/i.test(T),
      isPhantom: /PhantomJS/i.test(T),
      isWebkit: !R && /webkit/i.test(T),
      isChrome: !R && /chrome/i.test(T),
      isSafari: !R && /safari/i.test(T),
      browserVersion: I,
  ...
  function _(t) {
    return !K(t) && t && /^DIV|^P|^LI|^H[1-7]/.test(t.nodeName.toUpperCase());
  }
  var G = W("PRE"),
    Z = W("LI");
  var Y = W("TABLE"),
    Q = W("DATA");
  function X(t) {
    return !(nt(t) || J(t) || tt(t) || _(t) || Y(t) || ot(t) || Q(t));
  }
  function J(t) {
  ...
  var ot = W("BLOCKQUOTE");
  function nt(t) {
    return et(t) || ot(t) || K(t);
  }
  var it = W("A");
  var rt = W("BODY");
  var st = P.isMSIE && P.browserVersion < 11 ? "&nbsp;" : "<br>";
  function at(t) {
    return V(t) ? t.nodeValue.length : t ? t.childNodes.length : 0;
  }
  function lt(t) {
    var e = at(t);
    return (
      0 === e ||
      (!V(t) && 1 === e && t.innerHTML === st) ||
      !(!U.all(t.childNodes, V) || "" !== t.innerHTML)
    );
  }
  function ct(t) {
    q(t) || at(t) || (t.innerHTML = st);
  }
  function dt(t, e) {
    for (; t; ) {
      if (e(t)) return t;
  ...
  function yt(t, e) {
    if (!e) return !1;
    for (; t && t !== e; ) {
      if (kt(t) !== at(t.parentNode) - 1) return !1;
      t = t.parentNode;
    }
    return !0;
  }
  ...
  function wt(t, e) {
    ...
    if (0 === t.offset) {
      ...
      (o = t.node.parentNode), (n = kt(t.node));
    } else n = Ct(t.node) ? at((o = t.node.childNodes[t.offset - 1])) : ((o = t.node), e ? 0 : t.offset - 1);
    return { node: o, offset: n };
  }
  function xt(t, e) {
    var o, n;
    if (at(t.node) === t.offset) {
      if (K(t.node)) return null;
      (o = t.node.parentNode), (n = kt(t.node) + 1);
    } else n = Ct(t.node) ? ((o = t.node.childNodes[t.offset]), 0) : ((o = t.node), e ? at(t.node) : t.offset + 1);
    return { node: o, offset: n };
  }
  function St(t, e) {
  ...
  function $t(t, e) {
    ...
    if ((i && (o = !0), vt(t) && (V(t.node) || n))) {
      if (mt(t)) return t.node;
      if (gt(t)) return t.node.nextSibling;
    }
    if (V(t.node)) return t.node.splitText(t.offset);
    var r = t.node.childNodes[t.offset],
      s = pt(t.node.cloneNode(!1), t.node);
    return (
      ft(s, ht(r)),
      o || (ct(t.node), ct(s)),
      i && (lt(t.node) && Nt(t.node), lt(s)) ? (Nt(s), t.node.nextSibling) : s
    );
  }
  function It(t, o, n) {
    var e = ut(o.node, D.eq(t));
    return e.length
      ? 1 === e.length
        ? $t(o, n)
  ...
  var Lt = {
      ...
      isLeftEdgePointOf: function (t, e) {
        return mt(t) && bt(t.node, e);
      },
      isRightEdgePointOf: function (t, e) {
        return gt(t) && yt(t.node, e);
      },
      prevPoint: wt,
      nextPoint: xt,
      isSamePoint: St,
      isVisiblePoint: function (t) {
        if (V(t.node) || !Ct(t.node) || lt(t.node)) return !0;
      ...
      isCharPoint: function (t) {
        if (!V(t.node)) return !1;
        var e = t.node.nodeValue.charAt(t.offset - 1);
        return e && " " !== e && e !== j;
      },
      walkPoint: function (t, e, o, n) {
        for (var i = t; i && (o(i), !St(i, e)); )
          i = xt(i, n && t.node !== i.node && e.node !== i.node);
      },
      ancestor: dt,
      singleChildAncestor: function (t, e) {
        for (t = t.parentNode; t && 1 === at(t); ) {
          if (e(t)) return t;
          if (K(t)) break;
          t = t.parentNode;
        }
      ...
      commonAncestor: function (t, e) {
        for (var o = ut(t), n = e; n; n = n.parentNode)
      ...
      makeOffsetPath: function (t, e) {
        return ut(e, D.eq(t)).map(kt).reverse();
      },
      ...
      splitPoint: function (t, e) {
        ...
        var a =
          o && It(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
        return (
      ...
      isCustomStyleTag: function (t) {
        return t && !V(t) && U.contains(t.classList, "note-styletag");
      },
    },
    At = (function () {
      function t(t, e) {
    ...
    var s = function (t, e) {
        ...
        if (Lt.isText(t)) {
          var i = Lt.listPrev(t, D.not(Lt.isText)),
            r = U.last(i).previousSibling;
          (o = r || t.parentNode),
            (e += U.sum(U.tail(i), Lt.nodeLength)),
            (n = !r);
        } else {
  ...
  C.fn.extend({
    summernote: function () {
      var t = C.type(U.head(arguments)),
        e = "string" === t,
        o = "object" === t,
        i = C.extend({}, C.summernote.options, o ? U.head(arguments) : {});
      (i.langInfo = C.extend(
        !0,
        {},
        ...
        (i.tooltip = "auto" === i.tooltip ? !P.isSupportTouch : i.tooltip),
      ...
      if (n.length) {
        ...
        if (e) return r.invoke.apply(r, U.from(arguments));
  ...
  var Ht = (function () {
      ...
      return (
        (r.prototype.nativeRange = function () {
          ...
          var e = Pt({ node: this.sc, offset: this.so });
          return (
            e.setEndPoint("EndToEnd", Pt({ node: this.ec, offset: this.eo })), e
          );
        }),
        ...
        (r.prototype.normalize = function () {
          var t = function (t, e) {
              if (
                Lt.isVisiblePoint(t) &&
                (!Lt.isEdgePoint(t) ||
                  (Lt.isRightEdgePoint(t) && !e) ||
                  (Lt.isLeftEdgePoint(t) && e) ||
                  (Lt.isRightEdgePoint(t) &&
                    e &&
                    Lt.isVoid(t.node.nextSibling)) ||
                  (Lt.isLeftEdgePoint(t) &&
                    !e &&
                    Lt.isVoid(t.node.previousSibling)) ||
                  (Lt.isBlock(t.node) && Lt.isEmpty(t.node)))
              )
                return t;
        ...
        (r.prototype.wrapBodyInlineWithPara = function () {
          ...
          if (
            ...
            var i = Lt.wrap(U.head(n), "p");
            Lt.appendChildNodes(i, U.tail(n));
          }
        ...
        (r.prototype.paraBookmark = function (t) {
          return {
            s: {
              path: U.tail(Lt.makeOffsetPath(U.head(t), this.sc)),
              offset: this.so,
            },
            e: {
              path: U.tail(Lt.makeOffsetPath(U.last(t), this.ec)),
              offset: this.eo,
            },
          };
        }),
    ...
    Dt = {
      create: function (t, e, o, n) {
        if (4 === arguments.length) return new Ht(t, e, o, n);
        if (2 === arguments.length) return new Ht((o = t), (n = e), o, n);
      ...
      createFromBookmark: function (t, e) {
        var o = Lt.fromOffsetPath(t, e.s.path),
          ...
          r = e.e.offset;
        return new Ht(o, n, i, r);
      },
      createFromParaBookmark: function (t, e) {
        var o = t.s.offset,
          n = t.e.offset,
          i = Lt.fromOffsetPath(U.head(e), t.s.path),
          r = Lt.fromOffsetPath(U.last(e), t.e.path);
        return new Ht(i, o, r, n);
      },
    },
    Bt = {
      BACKSPACE: 8,
    ...
    zt = {
      isEdit: function (t) {
        return U.contains(
          [Bt.BACKSPACE, Bt.TAB, Bt.ENTER, Bt.SPACE, Bt.DELETE],
          t
        );
      },
      isMove: function (t) {
        return U.contains([Bt.LEFT, Bt.UP, Bt.RIGHT, Bt.DOWN], t);
      },
      nameFromCode: D.invertObject(Bt),
      code: Bt,
    };
  var Mt = (function () {
      function t(t) {
      ...
      return (
        ...
        (t.prototype.applySnapshot = function (t) {
          null !== t.contents && this.$editable.html(t.contents),
            null !== t.bookmark &&
              Dt.createFromBookmark(this.editable, t.bookmark).select();
        }),
    ...
    Ot = (function () {
      ...
      return (
        ...
        (t.prototype.stylePara = function (t, o) {
          C.each(t.nodes(Lt.isPara, { includeAncestor: !0 }), function (t, e) {
            C(e).css(o);
          });
        }),
        ...
        (t.prototype.current = function (t) {
          var e = C(Lt.isElement(t.sc) ? t.sc : t.sc.parentNode),
            o = this.fromNode(e);
          try {
            o = C.extend(o, {
    ...
    Ut = (function () {
      ...
      return (
        ...
        (t.prototype.indent = function (t) {
          var i = this,
            e = Dt.create(t).wrapBodyInlineWithPara(),
            o = e.nodes(Lt.isPara, { includeAncestor: !0 }),
            n = U.clusterBy(o, D.peq2("parentNode"));
          C.each(n, function (t, e) {
            var o = U.head(e);
            if (Lt.isLi(o)) {
        ...
        (t.prototype.outdent = function (t) {
          var n = this,
            e = Dt.create(t).wrapBodyInlineWithPara(),
            o = e.nodes(Lt.isPara, { includeAncestor: !0 }),
            i = U.clusterBy(o, D.peq2("parentNode"));
          C.each(i, function (t, e) {
            var o = U.head(e);
            Lt.isLi(o)
              ? n.releaseList([e])
        ...
        (t.prototype.toggleList = function (o, t) {
          var n = this,
            ...
            r = e.paraBookmark(i),
            s = U.clusterBy(i, D.peq2("parentNode"));
          if (U.find(i, Lt.isPurePara)) {
            var a = [];
          ...
          Dt.createFromParaBookmark(r, i).select();
        }),
        (t.prototype.wrapList = function (t, e) {
          ...
          return (
            ...
            r && (Lt.appendChildNodes(s, U.from(r.childNodes)), Lt.remove(r)),
            t
          );
        }),
            ...
            C.each(t, function (t, e) {
              ...
              if ("LI" === i.parentNode.nodeName)
                ...
                (e = c
                  ...
                  : U.from(a.childNodes).filter(Lt.isLi)),
                  (!c && Lt.isList(i.parentNode)) ||
                    (e = e.map(function (t) {
                      return Lt.replace(t, "P");
                    })),
                  C.each(U.from(e).reverse(), function (t, e) {
                    Lt.insertAfter(e, i);
                  });
                var l = U.compact([i, a, s]);
                C.each(l, function (t, e) {
      ...
      return (
        (t.prototype.insertTab = function (t, e) {
          ...
          (t = t.deleteContents()).insertNode(o, !0),
            (t = Dt.create(o, e)).select();
        }),
        (t.prototype.insertParagraph = function (t, e) {
          e = (e = (e =
            e || Dt.create(t)).deleteContents()).wrapBodyInlineWithPara();
          var o,
          ...
          Dt.create(o, 0).normalize().select().scrollIntoView(t);
        }),
        t
      );
    })(),
    Kt = function (t, h, p, i) {
      ...
      function k(t) {
        switch (h) {
          case Kt.where.Column:
            if (t.isColSpan) return Kt.resultAction.SubtractSpanCount;
            break;
          case Kt.where.Row:
            if (!t.isVirtual && t.isRowSpan) return Kt.resultAction.AddCell;
            if (t.isRowSpan) return Kt.resultAction.SubtractSpanCount;
        }
        return Kt.resultAction.RemoveCell;
      }
      function C(t) {
        switch (h) {
          case Kt.where.Column:
            if (t.isColSpan) return Kt.resultAction.SumSpanCount;
            if (t.isRowSpan && t.isVirtual) return Kt.resultAction.Ignore;
            break;
          case Kt.where.Row:
            if (t.isRowSpan) return Kt.resultAction.SumSpanCount;
            if (t.isColSpan && t.isVirtual) return Kt.resultAction.Ignore;
        }
        return Kt.resultAction.AddCell;
      }
      (this.getActionList = function () {
        for (
          var t,
            e,
            o,
            n = h === Kt.where.Row ? f.rowPos : -1,
            i = h === Kt.where.Column ? f.colPos : -1,
            r = 0,
            s = !0;
          s;
          ...
          var d = c[l];
          if (!d) return (s = !1), g;
          var u = Kt.resultAction.Ignore;
          switch (p) {
            case Kt.requestAction.Add:
              u = C(d);
              break;
            case Kt.requestAction.Delete:
              u = k(d);
          }
          g.push(
            ((t = u),
  ...
  (Kt.where = { Row: 0, Column: 1 }),
    (Kt.requestAction = { Add: 0, Delete: 1 }),
    (Kt.resultAction = {
      Ignore: 0,
      SubtractSpanCount: 1,
      RemoveCell: 2,
      ...
      return (
        ...
        (t.prototype.addRow = function (t, e) {
          for (
            ...
            switch (l.action) {
              case Kt.resultAction.AddCell:
                r.append("<td" + c + ">" + Lt.blank + "</td>");
                break;
              case Kt.resultAction.SumSpanCount:
                if ("top" === e)
                  if (
                    (l.baseCell.parent
        ...
        (t.prototype.addCol = function (t, e) {
          ...
          for (
            ...
            switch (s.action) {
              case Kt.resultAction.AddCell:
                "right" === e
                  ? C(s.baseCell).after("<td" + a + ">" + Lt.blank + "</td>")
                  : C(s.baseCell).before("<td" + a + ">" + Lt.blank + "</td>");
                break;
              case Kt.resultAction.SumSpanCount:
                if ("right" === e) {
                  ...
                  c &&
                    (2 < d
                      ...
                      : 2 === d &&
                        ...
                        (u.cells[n].innerHTML = "")));
                  continue;
                case Kt.resultAction.SubtractSpanCount:
                  c &&
                    (2 < d
                      ? (d--,
                      ...
                      : 2 === d &&
                        ...
                        l.rowIndex !== i &&
                          ...
                          (a.innerHTML = "")));
                  continue;
                case Kt.resultAction.RemoveCell:
                  continue;
              }
            }
          o.remove();
    ...
    qt = (function () {
        ...
        (this.insertParagraph = this.wrapCommand(function () {
          ...
          (this.insertNode = this.wrapCommand(function (t) {
            u.isLimited(C(t).text().length) ||
              ...
              Dt.createFromNodeAfter(t).select(),
              u.setLastRange());
          })),
          (this.insertText = this.wrapCommand(function (t) {
            if (!u.isLimited(t.length)) {
              var e = u.getLastRange().insertNode(Lt.createText(t));
              Dt.create(e, Lt.nodeLength(e)).select(), u.setLastRange();
            }
          })),
          (this.pasteHTML = this.wrapCommand(function (t) {
            if (!u.isLimited(t.length)) {
              ...
              Dt.createFromNodeAfter(U.last(e)).select(), u.setLastRange();
            }
          })),
          ...
          (this.insertHorizontalRule = this.wrapCommand(function () {
            var t = u.getLastRange().insertNode(Lt.create("HR"));
            t.nextSibling &&
              (Dt.create(t.nextSibling, 0).normalize().select(),
              u.setLastRange());
          })),
          ...
          (this.createLink = this.wrapCommand(function (t) {
            ...
            if (!(0 < r && u.isLimited(r))) {
              ...
              var c = Dt.createFromNodeBefore(U.head(a)).getStartPoint(),
                d = Dt.createFromNodeAfter(U.last(a)).getEndPoint();
              Dt.create(c.node, c.offset, d.node, d.offset).select(),
                u.setLastRange();
            }
          })),
      ...
      return (
        ...
        (t.prototype.handleKeyMap = function (t) {
          ...
          var n = zt.nameFromCode[t.keyCode];
          n && o.push(n);
          var i = e[o.join("+")];
          i
            ? !1 !== this.context.invoke(i) && t.preventDefault()
            : zt.isEdit(t.keyCode) && this.afterCommand();
        }),
        (t.prototype.preventDefaultEditableShortCuts = function (t) {
          (t.ctrlKey || t.metaKey) &&
            U.contains([66, 73, 85], t.keyCode) &&
            t.preventDefault();
        }),
          ...
          return (
            ...
            (void 0 === e ||
              !(
                ...
                e.ctrlKey ||
                e.metaKey ||
                U.contains([zt.code.BACKSPACE, zt.code.DELETE], e.keyCode)
              )) &&
        ...
        (t.prototype.setLastRange = function () {
          this.lastRange = Dt.create(this.editable);
        }),
          ...
          C.Deferred(function (t) {
            ...
            .then(function (t) {
              n.beforeCommand(),
                ...
                t.show(),
                Dt.create(n.editable).insertNode(t[0]),
                Dt.createFromNodeAfter(t[0]).select(),
                n.setLastRange(),
                n.afterCommand();
            })
            .fail(function (t) {
        ...
        (t.prototype.getSelectedText = function () {
          ...
          return (
            t.isOnAnchor() &&
              (t = Dt.createFromNode(Lt.ancestor(t.sc, Lt.isAnchor))),
            t.toString()
          );
        }),
          ...
          if (o) {
            ...
            if ((C(n).css(t, e), o.isCollapsed())) {
              ...
              i &&
                ...
                Dt.createFromNodeAfter(i.firstChild).select(),
                this.setLastRange(),
        ...
        (t.prototype.getLinkInfo = function () {
          var t = this.getLastRange().expand(Lt.isAnchor),
            e = C(U.head(t.nodes(Lt.isAnchor))),
            o = {
              range: t,
              text: t.toString(),
      ...
      return (
        ...
        (t.prototype.pasteByEvent = function (t) {
          ...
          if (e && e.items && e.items.length) {
            var o = 1 < e.items.length ? e.items[1] : U.head(e.items);
            "file" === o.kind &&
  ...
  P.hasCodeMirror && (Wt = window.CodeMirror);
  var Zt = (function () {
      function t(t) {
        (this.context = t),
          (this.$editor = t.layoutInfo.editor),
      ...
      return (
        ...
        (t.prototype.activate = function () {
          ...
          if (
            ...
            var o = Wt.fromTextArea(this.$codable[0], this.options.codemirror);
            if (this.options.codemirror.tern) {
              var n = new Wt.TernServer(this.options.codemirror.tern);
              (o.ternServer = n),
        ...
        (t.prototype.deactivate = function () {
          ...
          var e = this.purify(
              Lt.value(this.$codable, this.options.prettifyHtml) || Lt.emptyPara
            ),
      ...
      return (
        ...
        (t.prototype.handleKeydown = function (t) {
          if (
            ...
            U.contains(this.keys, this.previousKeydownCode)
          )
      ...
      function t(t) {
        (this.ui = C.summernote.ui),
          ...
          (this.invertedKeyMap = D.invertObject(
            this.options.keyMap[P.isMac ? "mac" : "pc"]
          ));
      }
      return (
        (t.prototype.representShortcut = function (t) {
          ...
          return this.options.shortcuts && e
            ? (P.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")),
              " (" +
                (e = e
                  .replace("BACKSLASH", "\\")
                  .replace("SLASH", "/")
          ...
          return (
            this.fontInstalledMap.hasOwnProperty(t) ||
              (this.fontInstalledMap[t] =
                P.isFontInstalled(t) ||
                U.contains(this.options.fontNamesIgnoreCheck, t)),
            this.fontInstalledMap[t]
          );
        }),
                  ...
                  click: function (t) {
                    ...
                    if ("openPalette" === n) {
                      ...
                      a
                        ...
                        s.prepend(a),
                        r.click();
                    } else if (U.contains(["backColor", "foreColor"], n)) {
        ...
        (t.prototype.updateCurrentStyle = function (t) {
          ...
          if (
            ...
            var i = o["font-family"].split(",").map(function (t) {
              ...
              r = U.find(i, this.isFontInstalled.bind(this));
          ...
          return C.Deferred(function (e) {
            ...
            a.ui.onDialogShown(a.$dialog, function () {
              a.context.triggerEvent("dialog.shown"),
                !s.url && D.isValidUrl(s.text) && (s.url = s.text),
                o
        ...
        (t.prototype.update = function (t, e) {
          if (Lt.isImg(t)) {
            var o = Lt.posFromPlaceholder(t),
              n = Lt.posFromPlaceholder(this.editable);
            this.$popover.css({
              display: "block",
      ...
      return (
        ...
        (t.prototype.update = function () {
          ...
          if (t.range && !t.range.isCollapsed()) {
            var e = U.last(t.range.getClientRects());
            if (e) {
              var o = D.rect2bnd(e);
              this.$popover.css({
                display: "block",
    ...
    fe = (function () {
      ...
      return (
        ...
        (t.prototype.replace = function () {
          ...
          if (t.length) {
            ...
            this.lastWordRange.insertNode(e),
              Dt.createFromNode(e).collapse().select(),
              (this.lastWordRange = null),
              this.hide(),
              this.context.triggerEvent(
                "change",
        ...
        (t.prototype.handleKeydown = function (t) {
          this.$popover.is(":visible") &&
            (t.keyCode === zt.code.ENTER
              ...
              : t.keyCode === zt.code.UP
              ? (t.preventDefault(), this.moveUp())
              : t.keyCode === zt.code.DOWN &&
        ...
        (t.prototype.handleKeyup = function (t) {
          var o = this;
          if (
            !U.contains([zt.code.ENTER, zt.code.UP, zt.code.DOWN], t.keyCode)
          ) {
            var e = this.context.invoke("editor.getLastRange").getWordRange(),
              n = e.toString();
            if (this.hints.length && n) {
              this.$content.empty();
              var i = D.rect2bnd(U.last(e.getClientRects()));
              i &&
                (this.$popover.hide(),
                (this.lastWordRange = e),
  ...
  (C.summernote = C.extend(C.summernote, {
    ...
    (C.summernote = C.extend(C.summernote, { ui: x }));
});
